...
function Header() {
  return (
    <header
      className="bg-transparent container-spacing fixed top-0 left-0 w-full py-5 md:py-3 z-40 header-container"
      ref={Header}
    >
      <div className=" between 2xl:container 2xl:mx-auto 2xl:px-9">
